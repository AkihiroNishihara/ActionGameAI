...
class GameEnd:
    def __init__(self, _screen):
        ...
        _is_loop = True
        _rect_title = class_generate_rect.Rectangle("Game End", is_centering=True, _color=(255, 0, 0),
                                                    _size_font=80)
        _rect_title.update_pos_rect(0, -100)

        _rect_ope = class_generate_rect.Rectangle("press Enter", is_centering=True, _color=(0, 255, 0), _size_font=60)
